					...
					{!isCalendarCollapsed ? (
						<>
							<div className="grid gap-3 lg:grid-cols-[minmax(0,1fr)_220px]">
								...
								<aside className="grid content-start gap-2 rounded-xl border border-neutral-200 bg-neutral-50 p-2.5 dark:border-neutral-600 dark:bg-neutral-700">
									<p className="text-[11px] font-semibold uppercase tracking-[0.06em] text-neutral-500 dark:text-neutral-300">
										Quick select
									</p>
